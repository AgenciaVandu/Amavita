...
@section('content')
<div class="modal fade" id="modal-ficha-citala" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 mt-2 pt-5 detalle-titulo-2">
                    <ul>
                        ...
                        <div class="d-none d-md-block d-lg-block">
                            <li><img src="{{ asset('img/modelos/citala/construccion-3.svg') }}" width="400"
                                    alt="Tipo de construccion"></li>
                        </div>
                        <div class="d-block d-md-none d-lg-none">
                            <li><img src="{{ asset('img/modelos/citala/construccion-3.svg') }}" width="340"
                                    alt="Tipo de construccion"></li>
                        </div>
                    </ul>
                    <div class="row pt-5">
                        <div class="col-md-6 col-sm-12 pt-2">
                            <a href="" class="hurmebold btn btn-secondary btn-block" data-toggle="modal"
                                data-target="#modal-ficha-citala">Ficha Técnica</a>
                        </div>
                        <div class="col-md-6 col-sm-12 pt-2">
                ...
                <div class="col-md-6 col-sm-12 pt-5 text-center">
                    <div class="row">
                        <div class="col-6">
                            <img src="{{ asset('img/modelos/citala/plano-1.png') }}" class="img-fluid"
